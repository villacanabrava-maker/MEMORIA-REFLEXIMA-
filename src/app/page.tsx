...
export default async function Home() {
  ...
  return (
    <AppShell active="inicio" title="Vamos organizar suas ideias?" eyebrow="Seu espaço de pensamento">
      <section className="hero" aria-labelledby="hero-title"><div className="hero-copy"><p className="kicker">Memória com origem. Reflexão com escolha.</p><h2 id="hero-title">Um lugar para guardar, compreender e relacionar o que merece ser lembrado.</h2><p>Adicione seu acervo, preserve os originais, transforme passagens importantes em evidências, registre memórias e revise as interpretações construídas sobre elas.</p><div className="workspace-actions"><Link className="workspace-button primary" href="/biblioteca/arquivos/novo">＋ Adicionar arquivo</Link><Link className="workspace-button neutral" href="/memoria/novo">Criar memória</Link><Link className="workspace-button neutral" href="/cerebro">Meu Cérebro</Link></div></div></section>
      ...
      <section className="library-panel" style={{ marginTop: 30 }}>
        <p className="eyebrow">Próxima camada</p>
        <h2>Criar Reflexão</h2>
        <p>Biblioteca, Evidências, Minha Memória e Meu Cérebro já possuem estruturas próprias. A próxima grande camada será o fluxo de reflexão guiada, usando somente contexto escolhido e rastreável.</p>
      </section>
    </AppShell>
  );
}
