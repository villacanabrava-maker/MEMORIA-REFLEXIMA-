...
export async function AppShell({ active, title, eyebrow, children }: { active: "inicio" | "biblioteca"; title: string; eyebrow: string; children: ReactNode }) {
    ...
    <div className="app-frame workspace">
      ...
      <aside className="sidebar">
        ...
        <nav className="workspace-nav" aria-label="Navegação principal">
          ...
          <span className="nav-future" aria-disabled="true" title="Meu Cérebro: em desenvolvimento"><span aria-hidden="true">◉</span><span className="nav-label">Meu Cérebro <small>Em breve</small></span></span>
        ...
        <div className="sidebar-bottom"><div className="privacy"><span aria-hidden="true">⌾</span><div><strong>Seu espaço de leitura</strong><p>Textos guardados com acesso por usuário.</p></div></div></div>
      </aside>
      <main id="main-content" tabIndex={-1}>
        ...
        {children}
        <footer><span>Memória com origem. Reflexão com escolha.</span><span>Biblioteca textual · Em construção</span></footer>
      </main>
    </div>
  );
}
