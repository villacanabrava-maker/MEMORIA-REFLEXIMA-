...
export async function AppShell({ active, title, eyebrow, children }: { active: "inicio" | "biblioteca" | "memoria"; title: string; eyebrow: string; children: ReactNode }) {
  ...
  return (
    <div className="app-frame workspace">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom"><div className="privacy"><span aria-hidden="true">⌾</span><div><strong>Seu espaço privado</strong><p>Originais, evidências e memórias com acesso por usuário.</p></div></div></div>
      </aside>
