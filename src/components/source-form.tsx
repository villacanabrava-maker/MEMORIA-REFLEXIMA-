...
import { characterCount, MAX_CONTENT, MAX_TITLE, type FormState } from "@/lib/sources/validation";
...
export function SourceForm({ source }: { source?: Source }) {
  ...
  return (
    <form action={action} className="source-form" aria-busy={pending}>
      ...
      <label htmlFor="source-content">Texto original</label>
      ...
      <p id="content-help" className="field-help">{contentLength.toLocaleString("pt-BR")} / 100.000 caracteres. O conteúdo será preservado como enviado.</p>
